...
Write a function feast that takes the animal's name and dish as arguments and returns true or false to indicate whether the beast is 
...
bool feast(std::string beast, std::string dish){
  //your code here
  return beast.at(0) == dish.at(0) && beast.back() == dish.back() ? true:false;
}
